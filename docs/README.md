...
- `build-state-after-phase2-build6.md` — the most recent build-state handoff (story-level stretch toggle); the latest comprehensive map of the code. Where it and the source disagree, the source wins.
...
- `phase2-buildN.md` — the current phase-2 build brief, numbered and incrementing. Only the latest brief stays live here (paired with the latest build-state); shipped briefs move to `docs/archive/`. The live brief is currently `phase2-build6.md` (story-level stretch toggle).
