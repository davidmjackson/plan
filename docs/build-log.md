...
- **Director review** (fill after reading brief2.md, then sign off): _Pending._ Record here: which of the five flagged rulings survived and which you overturned (location-as-array-membership; colour-key-not-literal; modal state out of store; new-story append-to-bottom; positive-integer points); how you ruled the two open scope edges (sub-1280px backlog drawer in or out; Resume/New-plan prompt fold-in or separate brief); and any other corrections issued to the brief before it went to Claude Code.
